...
class ApiClient {
  ApiClient({this.basePath = 'http://192.168.86.205:8080', this.authentication});
  ...
  static dynamic _deserialize(dynamic value, String targetType, {bool growable = false}) {
    try {
      switch (targetType) {
        ...
        case 'Codification':
          return Codification.fromJson(value);
        case 'Inventaire':
          return Inventaire.fromJson(value);
        case 'PeriodeInventaire':
